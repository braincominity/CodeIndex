...
- **MCP tool annotations** — All tools emit `annotations` (`readOnlyHint`, `destructiveHint`, `idempotentHint`, `openWorldHint`) per the MCP 2024-11-05 spec so AI clients can auto-approve safe read-only queries.
