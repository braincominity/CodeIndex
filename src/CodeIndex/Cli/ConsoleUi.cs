...
public static class ConsoleUi
{
    ...
    [
        ...
        ("db", "cdidx db --integrity-check [--db <path>] [--json] | cdidx db checkpoint [name] [--db <path>] [--json] | cdidx db checkpoints --list [--db <path>] [--json] | cdidx db restore <name> [--db <path>] [--json]"),
