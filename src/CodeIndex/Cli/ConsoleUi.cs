...
public static class ConsoleUi
{
    ...
    public static void PrintUsage(bool showBanner = true)
    {
        ...
        Console.WriteLine("  --exact                    Backward-compatible shorthand. Prefer --exact-substring for search and --exact-name for symbols/definition/references/callers/callees/inspect.");
