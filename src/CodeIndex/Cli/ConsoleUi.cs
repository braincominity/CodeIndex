...
public static class ConsoleUi
{
    ...
    [
        ...
        ("find", "cdidx find <query> --path <glob> [--db <path>] [--json] [--verbose] [--limit <n>|--top <n>] [--lang <lang>] [--exclude-path <glob>] [--exclude-tests] [--before <n>] [--after <n>] [--snippet-lines <n>] [--max-line-width <n>] [--exact] [--count]"),
