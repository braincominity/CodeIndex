...
public static partial class SymbolExtractor
{
    ...
    private static readonly Dictionary<string, List<SymbolPattern>> PatternCache = new()
    {
        ...
        [
            ...
            new("class",    new Regex(CppFunctionStartBlacklistPattern + CppTemplatePrefixPattern + @"class\s+(?<name>\w+)", RegexOptions.Compiled), BodyStyle.Brace),
            new("struct",   new Regex(CppFunctionStartBlacklistPattern + CppTemplatePrefixPattern + @"struct\s+(?<name>\w+)", RegexOptions.Compiled), BodyStyle.Brace),
