...
public static partial class SymbolExtractor
{
    ...
    private const string VbMemberModifierPattern = @"(?:Shared|Overrides|Overridable|MustOverride|Overloads|Shadows|Async|Iterator|Partial|Declare|Auto|Ansi|Unicode)";
    ...
    private static readonly Dictionary<string, List<SymbolPattern>> PatternCache = new()
    {
        ...
        [
            ...
            new("property", new Regex(@$"^\s*(?:(?:Shared|Shadows)\s+)*(?:(?<visibility>{VbVisibilityPattern})\s+)?(?:(?:Shared|Shadows)\s+)*Const\s+(?<name>\w+)", RegexOptions.Compiled | RegexOptions.IgnoreCase), BodyStyle.None, "visibility"),
