...
public class ConsoleUiTests
{
    ...
    [Fact]
    public void ShouldUseColor_Auto_NoColorEnvDisablesColor()
    {
        using var env = new ColorEnvironmentScope();
        Environment.SetEnvironmentVariable("NO_COLOR", "1");
    ...
    [Fact]
    public void ShouldUseColor_Auto_CliColorForceForcesColor()
    {
        using var env = new ColorEnvironmentScope();
        Environment.SetEnvironmentVariable("CLICOLOR_FORCE", "1");
        ConsoleUi.SetColorMode(ColorMode.Auto);
    ...
    [Fact]
    public void ShouldUseColor_Auto_CliColorZeroDisablesColor()
    {
        using var env = new ColorEnvironmentScope();
    ...
    [Fact]
    public void ShouldUseColor_NoColorBeatsCliColorForce_PrecedenceCheck()
    {
        // NO_COLOR is evaluated before CLICOLOR_FORCE, matching no-color.org guidance.
        using var env = new ColorEnvironmentScope();
        Environment.SetEnvironmentVariable("NO_COLOR", "1");
        Environment.SetEnvironmentVariable("CLICOLOR_FORCE", "1");
        ConsoleUi.SetColorMode(ColorMode.Auto);
