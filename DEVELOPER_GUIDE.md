...
| JavaScript | function, arrow, methods (including same-line keyword/modifier-named methods) | class, export default class, same-line sibling/statement-prefixed public classes, multiline/parenthesized/CommonJS class exports | -- | -- | -- | -- | -- | import...from | yes |
