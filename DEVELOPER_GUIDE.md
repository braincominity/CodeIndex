...
| Kotlin | fun, extension fun, modifier-heavy forms (`abstract`, `override`, `open`, `final`, `suspend`) | class, object, companion (anonymous companions normalize to `Companion`), data/sealed/value class | -- | interface | enum class, enum entries | val/var | -- | import | yes |
