...
| Batch | labels (`:name`), goto/call targets (reserved `:EOF` excluded) | -- | -- | -- | -- | `set VAR=`, `set /a VAR=`, `set /p VAR=`, `set "VAR=..."` | -- | -- | -- |
...
| Batch | ラベル (`:name`)、goto/call の着地点 (予約 `:EOF` は除外) | -- | -- | -- | -- | `set VAR=`、`set /a VAR=`、`set /p VAR=`、`set "VAR=..."` | -- | -- | -- |
