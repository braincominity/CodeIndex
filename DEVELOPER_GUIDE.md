...
| JavaScript | function, arrow, methods (including same-line keyword/modifier-named methods) | class, export default class, class expressions, multiline/CommonJS class exports | -- | -- | -- | -- | -- | import...from | yes |
| TypeScript | function, arrow, methods (including generic and same-line object/conditional/function-return methods) | class, export default class, multiline class expressions, type | -- | interface | enum, const enum | -- | -- | import...from | yes |
...
|---|---|---|---|---|---|---|---|---|:---:|
| Python | def, async def | class | -- | -- | -- | @property | -- | from/import | yes |
| JavaScript | function, アロー, メソッド（同一行の keyword / modifier 名メソッドを含む） | class, export default class, クラス式, 複数行 / CommonJS クラス export | -- | -- | -- | -- | -- | import...from | yes |
| TypeScript | function, アロー, メソッド（generic / 同一行 object-return / conditional / function-return を含む） | class, export default class, 複数行クラス式, type | -- | interface | enum, const enum | -- | -- | import...from | yes |
