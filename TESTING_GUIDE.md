...
- `IndexCommandRunnerTests.Run_CancelDuringFreshIndex_ReturnsInterruptedJson` and `Run_CancelDuringDryRunScan_ReturnsInterruptedJson`
...
- `IndexCommandRunnerTests.Run_CancelDuringFreshIndex_ReturnsInterruptedJson` と `Run_CancelDuringDryRunScan_ReturnsInterruptedJson`
