...
> **Maintainers / forkers only** — the full release procedure now lives in [DEVELOPER_GUIDE.md#release-workflow](DEVELOPER_GUIDE.md#release-workflow) and [MAINTAINERS.md](MAINTAINERS.md).
...
46言語対応。23 MCPツール。インクリメンタル更新。設定不要。
...
> **Maintainer・forker 向け** — 詳細なリリース手順は [DEVELOPER_GUIDE.md#release-workflow](DEVELOPER_GUIDE.md#release-workflow) と [MAINTAINERS.md](MAINTAINERS.md) に移しました。
