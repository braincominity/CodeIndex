...
| Solidity | `.sol` | -- |
| Tcl | `.tcl`, `.tk` | -- |
| R | `.r`, `.R` | yes (function assignments, methods::setClass/methods::setClassUnion/R6::R6Class/methods::setRefClass with named arguments, R6 public/private/active methods on the same line as other generator args, methods::setGeneric/methods::setMethod with named arguments, library/require) |
| Haskell | `.hs`, `.lhs` | yes |
| F# | `.fs`, `.fsx`, `.fsi` | yes |
| VB.NET | `.vb`, `.vbs` | yes |
